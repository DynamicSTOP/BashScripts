...
#cut and scale
ffmpeg -i $VIDFILENAME -ss 00:00:11.000 -t 00:00:15.000 -c:v libx264 -c:a aac -strict experimental -b:a 128k -vf scale="1280:-1" outc.mp4

#scale, change quality, and mute
ffmpeg -i $VIDFILENAME  -vf scale="1280:-1" -c:v h264_nvenc -cq 30  -an  outc.mp4 
